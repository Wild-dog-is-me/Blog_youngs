...
## 
<img src="/static/img/202205/11-card.png" style="width: 50%;">

如图，当页面切换到手机端时，这三个Crad会叠放起来，占用大量的空间，有些不雅观，因此需要对其进行修改。
找到主题目录下的`latouy/post.ejs`文件，搜索`<!-- content -->`，给对应的三个`div`添加样式`style="max-width: calc(100%/3)!important;"`即可：
```html
<div class="row">
    <div class="col-lg-4" style="max-width: calc(100%/3)!important;">
        ......
    </div>
    <div class="col-lg-4" style="max-width: calc(100%/3)!important;">
        ......
